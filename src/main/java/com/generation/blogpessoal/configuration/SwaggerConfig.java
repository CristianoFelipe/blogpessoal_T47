	...
	public OpenAPI springBlogPessoalOpenAPI() {
        ...
        return new OpenAPI()
				.info(new Info()
					...
					.description("Cristiano Faustino - Projeto Blog Pessoal - Generation Brasil")
					.version("v0.0.1")
				.license(new License()
					.name("")
					.url(""))
				.contact(new Contact()
					...
					.url("https://www.linkedin.com/in/cristianofelipenunesfaustino")
					.email("cristianofnunes97@gmail.com")))
				.externalDocs(new ExternalDocumentation()
					.description("Github CristianoFelipe")
					.url("https://github.com/CristianoFelipe/"));
	}
